...
- [ ] auto-doc/ADR-FORMAT.md line 82 still cites "execute-feature Step 3.4" — that step is now 3.1c, so the pointer dangles  `size:S` `area:docs` `src:RideAlongCandidates`
